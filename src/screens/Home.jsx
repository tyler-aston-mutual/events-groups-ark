...
export const ALL_ITEMS = [
  ...
  },
  {
    ...
    details: [
      { label: 'What to Bring', value: 'Water, snacks, sunscreen, and comfortable hiking shoes' },
      { label: 'Difficulty', value: 'Moderate — about 2.5 miles round trip with 1,100 ft elevation gain' },
  ...
  },
  {
    ...
    details: [
      { label: 'What to Bring', value: 'Paddle (loaners available), water bottle, athletic shoes' },
      { label: 'Skill Level', value: 'All levels welcome — we\'ll balance the teams' },
      { label: 'Cost', value: '$5 per person (covers court rental)' },
      { label: 'Dress Code', value: 'Athletic wear' },
    ],
  ...
  },
  {
    ...
    details: [
      { label: 'Dress Code', value: 'Dress warm! It\'ll be chilly' },
      { label: 'Cost', value: 'Free (bring money for hot chocolate)' },
  ...
  },
  {
    ...
    details: [
      { label: 'Vibe', value: 'Casual and fun — think good music and easy conversation' },
      { label: 'Age Range', value: '21–28' },
      { label: 'Cost', value: 'Cover your own food/drinks' },
  ...
  },
  {
    ...
    details: [
      { label: 'Team Size', value: '4–5 per team (we\'ll help you find one)' },
      { label: 'Topics', value: 'Pop culture, sports, history, church trivia, and more' },
      { label: 'Cost', value: 'Free to play — food/drinks on your own' },
    ],
  ...
  },
  {
    ...
    details: [
      { label: 'What to Bring', value: 'Swimsuit, towel, sunscreen, change of clothes' },
      { label: 'Cost', value: '$15 (group rate — normally $30). Lunch included' },
      { label: 'Duration', value: '11:00 AM – 5:00 PM' },
      { label: 'Age Range', value: '18–30' },
    ],
  ...
  },
  {
    ...
    details: [
      { label: 'Schedule', value: '9 AM check-in, 10 AM keynote, workshops till 4 PM, dance at 7 PM' },
      { label: 'Cost', value: 'Free' },
      { label: 'Dress Code', value: 'Sunday best for daytime, semi-formal for the evening dance' },
      { label: 'Parking', value: 'Free parking in the convention center garage' },
    ],
  ...
  },
  {
    ...
    details: [
      { label: 'Games', value: 'Codenames, Catan, Wavelength, and more — bring your favorites too!' },
      { label: 'What to Bring', value: 'A snack to share (optional)' },
      { label: 'Cost', value: 'Free' },
    ],
  ...
  },
  {
    ...
    details: [
      { label: 'Menu', value: 'Homemade pasta from scratch — we\'ll make the dough, sauce, and eat together' },
      { label: 'Skill Level', value: 'No experience needed — we\'ll teach you!' },
      { label: 'Cost', value: '$8 per person (covers ingredients)' },
      { label: 'What to Bring', value: 'An apron if you have one' },
    ],
